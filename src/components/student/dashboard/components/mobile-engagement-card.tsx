  ...
  return (
    <section className="w-full max-w-4xl mx-auto rounded-3xl bg-white/80 backdrop-blur shadow-lg border border-white/70 dark:bg-[#111827]/80 dark:border-white/10 dark:shadow-xl">
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center gap-2 rounded-full bg-gray-100 p-1.5 dark:bg-gray-800/80">
          {(
            [
            ...
            return (
              <button
                ...
                className={`flex-1 rounded-full px-3 py-2 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 dark:focus-visible:ring-offset-gray-900 ${
                  isActive
                    ? "bg-white shadow-sm text-gray-900 dark:bg-gray-900 dark:text-white"
